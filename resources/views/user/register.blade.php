        ...
        <section class="mt-10">
            <form action="/store" method="POST" class="flex flex-col">
                ...
                <div class="mb-6 pt-3 rounded bg-gray-200">
                    <label for="name" class="block tex-gray-700 text-sm font-bold mb-2 ml-3">
                        Name
                    </label>
                ...
                <div class="mb-6 pt-3 rounded bg-gray-200">
                    <label for="email" class="block tex-gray-700 text-sm font-bold mb-2 ml-3">
                        Email
                    </label>
                ...
                <div class="mb-6 pt-3 rounded bg-gray-200">
                    <label for="password" class="block tex-gray-700 text-sm font-bold mb-2 ml-3">
                        Password
                    </label>
                ...
                <div class="mb-6 pt-3 rounded bg-gray-200">
                    <label for="password_confirmation" class="block tex-gray-700 text-sm font-bold mb-2 ml-3">
                        Confirm Password
                    </label>
